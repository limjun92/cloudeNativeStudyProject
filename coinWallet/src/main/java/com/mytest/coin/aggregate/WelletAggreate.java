...
public class WelletAggreate {
    ...
    public WelletAggreate(AddBalanceCommand command) {
    	...
    	System.out.println(command.getTradeId() + " " + command.getBalance() + " " +  command.getName());
    	apply(new BalanceAddEvent(this.id, command.getName(), command.getBalance()));
    }
    ...
    public WelletAggreate(MinusBalanceCommand command) {
    	...
    	apply(new BalanceMinusEvent(this.id, command.getName(), command.getBalance()));
    }
