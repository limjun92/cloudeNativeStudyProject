...
public class WebMvcConfiguration implements WebMvcConfigurer {
	...
	public void addCorsMappings(CorsRegistry registry) {
		...
		.allowedHeaders("*")
		.allowedOrigins("http://localhost:8080","http://localhost:8081","http://localhost:8082","http://14.63.222.111:8087", "http://localhost:8088", "http://ec2-15-165-15-254.ap-northeast-2.compute.amazonaws.com:8080")
